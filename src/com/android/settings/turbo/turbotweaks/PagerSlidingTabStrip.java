...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int textPrimaryColor = context.getResources().getColor(com.android.settings.R.color.material_deep_teal_500);
        int tabTextColor = context.getResources().getColor(com.android.settings.R.color.material_deep_teal_500);

...
public class RecentsSettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private static final String CATEGORY_STOCK_RECENTS = "stock_recents_category";
    private static final String CATEGORY_OMNI_RECENTS = "omni_recents_category";
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_RESET, 0, R.string.slim_recents_reset_message)
    ...
    private void resetToDefault() {
        ...
        alertDialog.setMessage(R.string.slim_recents_reset_message);

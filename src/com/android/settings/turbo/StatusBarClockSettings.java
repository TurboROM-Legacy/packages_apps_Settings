...
public class StatusBarClockSettings extends SettingsPreferenceFragment
    ...
    private static final String PREF_COLOR_OVERRIDE = "status_bar_clock_color_override";
    ...
    private PreferenceScreen createCustomView() {
        ...
        mClockStyle.setValue(Integer.toString(Settings.System.getInt(getActivity()
                .getContentResolver(), Settings.System.STATUS_BAR_CLOCK_STYLE,
                0)));
        ...
        mClockAmPmStyle.setValue(Integer.toString(Settings.System.getInt(getActivity()
                .getContentResolver(), Settings.System.STATUS_BAR_CLOCK_AM_PM_STYLE,
                0)));
        ...
        int intColor = Settings.System.getInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_COLOR, -2);
        if (intColor == -2) {
        ...
        mClockDatePosition.setValue(Integer.toString(Settings.System.getInt(getActivity()
                .getContentResolver(), Settings.System.STATUS_BAR_CLOCK_DATE_POSITION,
                0)));
        ...
        mStatusBarClockColorOverride.setChecked((Settings.System.getInt(
                getActivity().getApplicationContext().getContentResolver(),
                Settings.System.STATUS_BAR_CLOCK_COLOR_OVERRIDE, 0) == 1));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_AM_PM_STYLE, val);
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_STYLE, val);
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_DATE_POSITION, val);
            mClockDatePosition.setSummary(mClockDatePosition.getEntries()[index]);
            parseClockDateFormats();
            return true;
        } else if (preference == mStatusBarClockColorOverride) {
            Settings.System.putInt(getActivity().getApplicationContext().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_COLOR_OVERRIDE,
                    (Boolean) newValue ? 1 : 0);
            return true;
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setMessage(R.string.status_bar_clock_color_reset_message)
